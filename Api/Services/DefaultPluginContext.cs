...
/// <summary>
    ...
    public class DefaultUIService : IUIService
    {
        ...
        private readonly Dictionary<Guid, List<System.Windows.Controls.UserControl>> _channelComponents = new();
        ...
        public void RegisterChannelHeaderComponent(Guid channelId, System.Windows.Controls.UserControl component)
        {
            ...
            {
                _channelComponents[channelId] = new List<System.Windows.Controls.UserControl>();
            }
        ...
        public void ShowNotification(string title, string message, PluginContracts.Models.NotificationType type = PluginContracts.Models.NotificationType.Info)
        {
        ...
        public IEnumerable<System.Windows.Controls.UserControl> GetChannelComponents(Guid channelId)
        {
